...
:data DISSIMILAR:             the same as :attr DEFAULT: but excludes similar 
...
:data URLSAFE_DISSIMILAR:     the same as :attr URLSAFE: but excluding similar
                              characters.
"""

HEX = '0123456789abcdef'
DEFAULT = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'
DISSIMILAR = '23456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz'
